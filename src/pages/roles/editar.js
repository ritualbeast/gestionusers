...
import { ConsultarPermisos } from '../../services/ServicesRol';
            ...
            <Form.Group controlId="canal">
              ...
              <Select
                ...
                onChange={(selectedOption) => {
                  const canalValue = selectedOption ? selectedOption.value : '';
                  setFormState((prevState) => ({ ...prevState, canal: canalValue }));
                }}
                required
              />
            </Form.Group>
